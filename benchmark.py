...
def plot_coverage_results(results, title="Similar testing dataset"):
    color_map = {"RL-NBV":"#C4323F", "Random":"#EF4143", "AF":"#033250", "PC":"#73BAD6"}
    markerfacecolor_map = {"RL-NBV":"none", "Random":"#EF4143", "AF":"none", "PC":"#73BAD6"}
    marker_map = {"RL-NBV":"^", "Random":"o", "AF":"s", "PC":"v"}
    fig, ax = plt.subplots()
    ...
    ax.set_xlabel("Number of rounds", fontsize='x-large')
    ax.set_ylabel("Average coverage", fontsize='x-large')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_dqn', type=int, default=0)
    ...
    if args.test_information_gain == 1:
        adapter = InformationGainAdapter(test_env, logger, args)
        algorithms["IG"] = adapter.IGExplore
